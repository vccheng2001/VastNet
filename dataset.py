...
datasets_of_interest = ['ENA24']

# All lower-case; we'll convert category names to lower-case when comparing
species_of_interest = ['human', 'dog', 'bird', 'domestic cat', 'american black bear', 'white_tailed_deer', 'vehicle', 'northern raccoon']

# We'll write images, metadata downloads, and temporary files here
output_dir = f'darknet/backup/'
...
if use_azcopy_for_download:
    ...
    for ds_name in downloads_by_dataset:
        ...
        cmd = '~/Desktop/azcopy_linux_amd64_10.13.0/azcopy "{0}" "{1}" --list-of-files "{2}"'.format(
